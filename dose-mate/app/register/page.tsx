      ...
      <div className="w-full max-w-md">
        ...
        <Card className="border-2">
          <CardHeader className="text-center">
            ...
            <CardDescription>Join Dose Mate to start managing medications safely</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Input id="password" type="password" placeholder="Create a strong password" className="h-11" />
            </div>
            <div className="space-y-2">
